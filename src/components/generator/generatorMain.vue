...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          text: "main.settingsList.generator_mode",
      ...
      switch (item.text) {
        case "main.settingsList.waveform":
          this.DialogData = {
            ...
            select: this.$store.getters.get_D09,
            type: "waveform",
          };
        ...
        case "main.settingsList.timer_off":
          this.DialogData = {
            title: "main.titles.session_duration",
            list: [
              { id: 0, text: "timer_off_values.off" },
              { id: 1, text: "timer_off_values.m15" },
              { id: 2, text: "timer_off_values.m30" },
              { id: 3, text: "timer_off_values.m45" },
              { id: 4, text: "timer_off_values.m60" },
            ],
            select: 3,
            type: "timer_off",
          };
        ...
        case "main.settingsList.timer_on":
          this.DialogData = {
            title: "main.titles.period_between_on",
            list: [
              { id: 0, text: "timer_on_values.off" },
              { id: 1, text: "timer_on_values.h1" },
              { id: 2, text: "timer_on_values.h2" },
              { id: 3, text: "timer_on_values.h3" },
              { id: 4, text: "timer_on_values.h4" },
              { id: 5, text: "timer_on_values.h5" },
              { id: 6, text: "timer_on_values.h6" },
              { id: 7, text: "timer_on_values.h7" },
              { id: 8, text: "timer_on_values.h8" },
              { id: 9, text: "timer_on_values.h9" },
              { id: 12, text: "timer_on_values.h12" },
              { id: 24, text: "timer_on_values.h24" },
            ],
            select: 0,
            type: "timer_on",
          };
        ...
        case "main.settingsList.power":
          this.DialogData = {
            title: "main.titles.load_current",
            value: this.$store.getters.getD14,
            type: "power",
          };
        ...
        case "main.settingsList.frequency":
          this.DialogData = {
            value: this.$store.getters.getD07,
            type: "frequency",
        ...
        case "main.settingsList.phase_shift":
          this.DialogData = {
            value: this.$store.getters.getD18,
            type: "phase_shift",
          };
